...
//
//            if (ddate != null) {
//                Group group = new Group(0, work, location, discription, startTm, endTm, ddate, (int)userId, null, LimitMembersNumber, 1, imageGroupResourceId);
//
...
//                            Group createdGroup = response.body(); // Get the created group with the groupId
//                            long groupId = createdGroup.getId(); // Assuming the group object has an `id` field
//
//                            // Now add the user as an admin to the group
//                            Call<Void> addUserCall = usergroupApi.addUserToGroup(userId, groupId, "join");
//                            addUserCall.enqueue(new Callback<Void>() {
//                                @Override
//                                public void onResponse(Call<Void> call, Response<Void> response) {
//                                    if (response.isSuccessful()) {
//                                        Toast.makeText(AddGroupActivity.this, "User added as admin successfully", Toast.LENGTH_SHORT).show();
...
//                                    } else {
//                                        Toast.makeText(AddGroupActivity.this, "Failed to add user to group", Toast.LENGTH_SHORT).show();
//                                    }
//                                }
//
//                                @Override
