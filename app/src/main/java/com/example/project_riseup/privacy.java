...
<<<<<<<< HEAD:app/src/main/java/com/example/project_riseup/privacy.java
========
import android.widget.ImageView;
import android.widget.TextView;
>>>>>>>> origin/Israa:app/src/main/java/com/example/project_riseup/FavActivites.java
...
//
//        // Helper method to update the TextView color
//        private void updateTextColor (ImageView imageView, TextView textView,int defaultColor,
//        int greenColor, String activityName){
